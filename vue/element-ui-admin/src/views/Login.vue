...
<div class="login-container">
    ...
    label-position="left">
        ...
        <el-form-item prop="username">
            ...
            autoComplete="on" placeholder="请输入用户名" @keyup.enter.native="handleLogin"></el-input>
        </el-form-item>
        <el-form-item prop="password">
            <el-input name="password" type="password" v-model="loginForm.password"
            autoComplete="on" @keyup.enter.native="handleLogin" ></el-input>
        </el-form-item>
        ...
        <el-dialog :visible.sync="showDialog" append-to-body title="第三方登录">
            微信，QQ，微博
            <br>
        </el-dialog>
    </el-form>
...
export default {
    ...
    methods: {
        handleLogin() {
            ...
            //验证通过： 模拟 ajax 请求效果，loading 效果 2s
        }
    }
}
</script>
